...
public:
    rectangle() = default;
    rectangle(point bottom_left, point top_right) : _bottom_left{bottom_left}, _top_right{top_right} {}
    ...
    unsigned int width() const { return _top_right.x() - _bottom_left.x(); }
    unsigned int height() const { return _top_right.y() - _bottom_left.y(); }
